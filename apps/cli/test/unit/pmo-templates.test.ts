...
describe('PMO Board Templates', () => {
  ...
  // PRLT-1299: Local workflow/status tables removed — listWorkflows/listStatuses are dead methods
  describe.skip('DRY - Database seeding uses BUILTIN_TEMPLATES' /* PRLT-1299: removed */, () => {
    let testDir: string;
