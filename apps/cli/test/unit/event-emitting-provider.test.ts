...
class MockProvider implements TicketProvider {
  ...
  async updateTicket(): Promise<ProviderUpdateResult> { return { success: true, provider: 'pmo', ticket: null } }
  async commentTicket(): Promise<ProviderCommentResult> { return { success: true, provider: 'pmo' } }
}
...
class MockLinearProvider implements TicketProvider {
  ...
  async updateTicket(): Promise<ProviderUpdateResult> { return { success: true, provider: 'linear', ticket: null } }
  async commentTicket(): Promise<ProviderCommentResult> { return { success: true, provider: 'linear' } }
}
