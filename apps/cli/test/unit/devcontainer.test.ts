...
describe('Devcontainer', () => {
  ...
  describe('Claude Code version pinning (PRLT-1084)', () => {
    ...
    describe('generateDevcontainerJson', () => {
      ...
      // PRLT-1240: Version pin removed — -p mode skips all onboarding
      it('should NOT include CC_VERSION when claudeCodeVersion is not specified', () => {
        const options = makeOptions()
        const result = generateDevcontainerJson(options)
      ...
      it('should NOT include CC_VERSION when claudeCodeVersion is undefined', () => {
