...
/**
 * Local async version of agentExec that uses execInProcess instead of execProduction.
 */
...
/**
 * Local async version of execFinal that uses execInProcess instead of execProduction.
 * Strips --json, --machine, and -m flags before executing.
 */
...
describe('Spec Commands - JSON Mode E2E Tests', () => {
  ...
  describe('prlt spec create --machine', () => {
    it('should output title input prompt when no title provided', async () => {
      const result = await agentExec('spec create --machine');
    ...
    it('should output type selection prompt in interactive mode with title', async () => {
      ...
      const result = await agentExec('spec create "Test Spec" -i --machine');
    ...
    it('should work with -m shorthand', async () => {
      const result = await agentExec('spec create -m');
  ...
  describe('prlt spec view --machine', () => {
    ...
    it('should output spec selection prompt when no spec ID provided', async () => {
      const result = await agentExec('spec view -P test-project --machine');
  ...
  describe('prlt spec plan --machine', () => {
    ...
    it('should output spec selection prompt when no spec ID provided', async () => {
      const result = await agentExec('spec plan --machine');
  ...
  describe('prlt spec ticket --machine', () => {
    ...
    it('should output ticket selection prompt when no ticket ID provided', async () => {
      const result = await agentExec('spec ticket -P test-project --machine');
    ...
    it('should output spec selection prompt when ticket ID provided', async () => {
      const result = await agentExec('spec ticket TKT-LINK-1 -P test-project --machine');
  ...
  describe('prlt spec link --machine', () => {
    ...
    it('should output spec selection prompt when no spec ID provided', async () => {
      const result = await agentExec('spec link --machine');
  ...
  describe('prlt spec link depends --machine', () => {
    ...
    it('should output target spec selection prompt when target not provided', async () => {
      const result = await agentExec('spec link depends depends-spec-1 --machine');
  ...
  describe('prlt spec link remove --machine', () => {
    ...
    it('should output dependency selection prompt when target not provided', async () => {
      const result = await agentExec('spec link remove remove-spec-1 --machine');
    ...
    it('should return error when no dependencies exist', async () => {
      ...
      const result = await agentExec('spec link remove no-deps-spec --machine');
  ...
  describe('End-to-end agent flows (--machine flag)', () => {
    describe('spec create - full agent flow', () => {
      it('should complete flow: enter title → select type → spec created (interactive mode)', async () => {
        ...
        const step1 = await agentExec('spec create --machine');
        ...
        const step2 = await agentExec('spec create "Agent Created Spec" -i --machine');
        ...
        const result = await execFinal(execChoice(typeChoice!));
    ...
    describe('spec view - full agent flow', () => {
      ...
      it('should complete flow: select spec → view details', async () => {
        ...
        const step1 = await agentExec('spec view -P test-project --machine');
        expect(step1).to.not.be.null;
    ...
    describe('spec ticket - full agent flow', () => {
      ...
      it('should complete flow: select ticket → select spec → ticket linked', async () => {
        ...
        const step1 = await agentExec('spec ticket -P test-project --machine');
        expect(step1).to.not.be.null;
        expect(step1!.prompt.type).to.equal('list');
    ...
    describe('spec link depends - full agent flow', () => {
      ...
      it('should complete flow: select target → dependency created', async () => {
        ...
        const step1 = await agentExec('spec link depends dep-flow-1 --machine');
        expect(step1).to.not.be.null;
        expect(step1!.prompt.type).to.equal('list');
    ...
    describe('spec link remove - full agent flow', () => {
      ...
      it('should complete flow: select dependency → dependency removed', async () => {
        ...
        const step1 = await agentExec('spec link remove rem-flow-1 --machine');
        expect(step1).to.not.be.null;
        expect(step1!.prompt.type).to.equal('list');
        expect(step1!.prompt.name).to.equal('target');
        ...
        const result = await execFinal(execChoice(depChoice!));
    ...
    describe('backward compatibility: --json flag flows', () => {
      ...
      it('should complete create flow with --json flag (legacy) in interactive mode', async () => {
        // Use -i flag to get type selection prompt
        const step1 = await agentExec('spec create "Legacy JSON Spec" -i --json');
        expect(step1).to.not.be.null;
        expect(step1!.prompt.type).to.equal('list');
