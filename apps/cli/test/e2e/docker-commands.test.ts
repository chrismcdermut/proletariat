...
import { execInProcess as exec } from './test-helpers.js'
...
describe('Docker Commands E2E Tests', () => {
  ...
  describe('prlt docker status', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker status --help')
    ...
    it('should report Docker status', async () => {
      const output = await exec('docker status')
  ...
  describe('prlt docker list', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker list --help')
    ...
    it('should accept --all flag without unknown flag error', async () => {
      const output = await exec('docker list --all --help')
    ...
    it('should accept --running flag without unknown flag error', async () => {
      const output = await exec('docker list --running --help')
    ...
    it('should handle missing workspace gracefully', async () => {
      const output = await exec('docker list')
  ...
  describe('prlt docker clean', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker clean --help')
    ...
    it('should accept --dry-run flag without unknown flag error', async () => {
      const output = await exec('docker clean --dry-run --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should accept --all flag without unknown flag error', async () => {
      const output = await exec('docker clean --all --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should accept --force flag without unknown flag error', async () => {
      const output = await exec('docker clean --force --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should handle missing workspace gracefully', async () => {
      const output = await exec('docker clean --force')
    ...
    it('should accept --machine flag for JSON mode support', async () => {
      const output = await exec('docker clean --machine --help')
  ...
  describe('prlt docker logs', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker logs --help')
    ...
    it('should accept --follow flag without unknown flag error', async () => {
      const output = await exec('docker logs --follow --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should accept --tail flag without unknown flag error', async () => {
      const output = await exec('docker logs --tail 50 --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should require a target argument', async () => {
      const output = await exec('docker logs')
    ...
    it('should accept execution ID format', async () => {
      const output = await exec('docker logs WORK-001')
  ...
  describe('prlt docker stop', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker stop --help')
    ...
    it('should accept --force flag without unknown flag error', async () => {
      const output = await exec('docker stop --force --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should accept --time flag without unknown flag error', async () => {
      const output = await exec('docker stop --time 30 --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should require a target argument', async () => {
      const output = await exec('docker stop')
    ...
    it('should accept --machine flag for JSON mode support', async () => {
      const output = await exec('docker stop --machine --help')
  ...
  describe('prlt docker shell', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker shell --help')
    ...
    it('should accept --shell flag without unknown flag error', async () => {
      const output = await exec('docker shell --shell /bin/bash --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should accept --user flag without unknown flag error', async () => {
      const output = await exec('docker shell --user root --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should require a target argument', async () => {
      const output = await exec('docker shell')
  ...
  describe('prlt docker restart', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker restart --help')
    ...
    it('should accept --force flag without unknown flag error', async () => {
      const output = await exec('docker restart --force --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should require a target argument', async () => {
      const output = await exec('docker restart')
    ...
    it('should accept --machine flag for JSON mode support', async () => {
      const output = await exec('docker restart --machine --help')
  ...
  describe('prlt docker start', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker start --help')
    ...
    it('should require a target argument', async () => {
      const output = await exec('docker start')
    ...
    it('should accept execution ID format', async () => {
      const output = await exec('docker start WORK-001')
  ...
  describe('prlt docker sync', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker sync --help')
    ...
    it('should handle missing workspace gracefully', async () => {
      const output = await exec('docker sync')
  ...
  describe('prlt docker prune', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker prune --help')
    ...
    it('should accept --dry-run flag without unknown flag error', async () => {
      const output = await exec('docker prune --dry-run --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should accept --all flag without unknown flag error', async () => {
      const output = await exec('docker prune --all --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should accept --volumes flag without unknown flag error', async () => {
      const output = await exec('docker prune --volumes --help')

      expect(output).to.not.contain('Unknown flag')
    })

    it('should handle Docker not running gracefully', async () => {
      const output = await exec('docker prune --force')
    ...
    it('should accept --machine flag for JSON mode support', async () => {
      const output = await exec('docker prune --machine --help')
  ...
  describe('prlt docker', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('docker --help')
  ...
  describe('JSON Mode Output', () => {
    ...
    it('prlt docker --json should output action menu as JSON', async () => {
      const output = await exec('docker --json')
    ...
    it('prlt docker clean --json should output confirm prompt or error', async () => {
      const output = await exec('docker clean --json')
      const json = tryParsePromptJson(output)
    ...
    it('prlt docker prune --json should output confirm prompt or error', async () => {
      const output = await exec('docker prune --json')
      const json = tryParsePromptJson(output)
    ...
    it('prlt docker stop <target> --json should output confirm prompt or error', async () => {
      const output = await exec('docker stop test-container --json')
      const json = tryParsePromptJson(output)
    ...
    it('prlt docker restart <target> --json should output confirm prompt or error', async () => {
      const output = await exec('docker restart test-container --json')
      const json = tryParsePromptJson(output)
    ...
    it('--force flag should skip confirmation prompt in JSON mode', async () => {
      const output = await exec('docker clean --force --json')
...
describe('Docker Agent Flow E2E Tests (--machine flag)', () => {
  ...
  describe('docker stop - confirmation flow', () => {
    ...
    it('should skip confirmation with --force flag', async () => {
      const output = await exec('docker stop test-container --force')
  ...
  describe('docker restart - confirmation flow', () => {
    ...
    it('should skip confirmation with --force flag', async () => {
      const output = await exec('docker restart test-container --force')
  ...
  describe('docker clean - confirmation flow', () => {
    ...
    it('should accept --dry-run to show preview without removing', async () => {
      const output = await exec('docker clean --dry-run')
  ...
  describe('docker prune - confirmation flow', () => {
    ...
    it('should accept --dry-run to show preview without pruning', async () => {
      const output = await exec('docker prune --dry-run')
  ...
  describe('full agent navigation flows', () => {
    ...
    it('should navigate: main menu → select status → direct execution (no prompt)', async () => {
      ...
      const output = await exec(execChoice(statusChoice!))
  ...
  describe('--machine vs --json vs -m equivalence', () => {
    it('--machine and --json should produce equivalent output structure', async () => {
      const machineOutput = await exec('docker --machine')
      const jsonOutput = await exec('docker --json')
