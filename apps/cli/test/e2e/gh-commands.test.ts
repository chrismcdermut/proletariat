...
describe('GitHub CLI Commands E2E Tests', () => {
  ...
  describe('prlt gh status', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('gh status --help')
    ...
    it('should check GitHub CLI status', async () => {
      const output = await exec('gh status')
  ...
  describe('prlt gh login', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('gh login --help')
  ...
  describe('prlt gh token', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('gh token --help')
  ...
  describe('prlt gh', () => {
    it('should show help with --help flag', async () => {
      const output = await exec('gh --help')
  ...
  describe('Error handling', () => {
    it('should handle unknown subcommand gracefully', async () => {
      const output = await exec('gh unknown-subcommand')
    ...
    it('should accept --help flag on all subcommands', async () => {
      const statusHelp = await exec('gh status --help')
      const loginHelp = await exec('gh login --help')
      const tokenHelp = await exec('gh token --help')
