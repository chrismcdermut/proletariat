 ...
 * removed. Projects are now simple containers for HQ scoping — the provider
 * (Linear, Jira, etc.) is the source of truth for tickets and workflows.
 */

import { eq, and, like, or, asc, desc, sql } from 'drizzle-orm'
import { pmoProjects } from '../../database/drizzle-schema.js'
import { PMOError, Project, ProjectFilter } from '../types.js'
...
export class ProjectStorage {
   ...
   * Tries: exact ID, case-insensitive ID, exact name, case-insensitive name, slug.
   */
