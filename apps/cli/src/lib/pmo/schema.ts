...
export const PMO_TABLES = {
  ...
  agent_profiles: 'pmo_agent_profiles',  // Agent profiles (config-based agent behavior)
...
export const PMO_SCHEMA_SQL = [
  ...
  PMO_TABLE_SCHEMAS.agent_profiles,  // Agent profiles (config-based agent behavior)
