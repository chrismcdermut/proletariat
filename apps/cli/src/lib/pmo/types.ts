 ...
 * Intents are resolved to provider states via the state resolution engine.
 */
export interface WorkAction {
  ...
  fromIntent?: string                         // Intent name for auto-trigger (nullable — manual only)
  toIntent?: string                           // Target intent after action completes (resolved to provider state)
...
export interface PMOStorage {
  ...
  getSuggestedAction(intentOrStateName: string): Promise<WorkAction | null>
