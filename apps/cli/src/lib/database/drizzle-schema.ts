 ...
 * vestigial tables have been removed. The provider is the source of truth.
 */
...
// =============================================================================
// PMO Tables (kept after PRLT-1299 dead table removal)
// =============================================================================
 ...
 * (Rekeyed in PRLT-1299: pmo_ticket_id dropped, PK is now (provider, external_id))
 */
...
/**
 * Ticket metadata (free-form key-value, keyed by provider ticket ID)
 */
