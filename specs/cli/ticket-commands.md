...
> **Note**: For work execution (ownership, assignment, agent runtime), see [execute-commands.md](execute-commands.md). The `prlt work` namespace handles starting agents, marking work ready/complete, claiming, and assigning work.
