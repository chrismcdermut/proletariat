...
| TKT-080 | Add e2e testing infrastructure for interactive prompts | backlog | P1 | feature | Currently e2e tests bypass interactive prompts by using command-line flags. To properly test interactive flows (inquirer prompts), we need testing infrastructure that can simulate user input.  Opti... |
